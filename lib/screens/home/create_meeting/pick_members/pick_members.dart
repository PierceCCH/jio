...
class _PickMembersState extends State<PickMembers> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamProvider.value(
      ...
      child: Scaffold(
          appBar: AppBar(
              title: Text("Pick your friends"), backgroundColor: Colors.orange),
          body: Container(
            //background
...
//////////////TIME AND ADDRESS INFORMATION////////////////////////////
                Padding(
                  ...
                  child: Text("The meeting will be on",
                      style: TextStyle(
                        fontSize: 20,
                      )),
                ),
...
/////////////////////////////////////////////////////////////////////////////////
                ...
                Container(
                  ...
                  child: TextFormField(
                      ...
                      validator: (val) =>
                          val != null ? null : "Please input a name",
                      ...
                      child: FlatButton(
                          ...
                          onPressed: () {
                            ...
                            if (friendsToMeet.length != 0) {
                              ...
                              createMeeting(widget.address, widget.dateAndTime,
                                  user.uid, friendsToMeet, name);
                              Navigator.push(
                                context,
