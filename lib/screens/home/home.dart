  ...
  Widget menuboard(context) {
    return Container(
      ...
      child: Align(
          ...
          child: Padding(
            padding: EdgeInsets.fromLTRB(0.05*screenWidth, 0.10*screenHeight, 0, 0),
            child: Container(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                      children: <Widget>[
                      Icon(Icons.person, color: menuTabColor,),
                      FlatButton(
                        onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context) => Profile()),);
                        },
                        child: Text("Profile", style: TextStyle(color: menuTabColor, fontSize: 20),)),
                      ]
                  ),
                  //Contacts button
                  SizedBox(height: 10),
                  Row(
                      children: <Widget>[
                      Icon(Icons.contacts, color: menuTabColor,),
                      FlatButton(
                        onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context) => FriendsPage()),);
                        },
                        child: Text("Contacts", style: TextStyle(color: menuTabColor, fontSize: 20),)),
                      ]
                  ),
                  //Groups button
                  SizedBox(height: 10),
                  Row(
                      children: <Widget>[
                      Icon(Icons.group, color: menuTabColor,),
                      FlatButton(
                      onPressed: (){

                      },
                      child: Text("Groups", style: TextStyle(color: menuTabColor, fontSize: 20),)),
                      ]
                  ),
                  //White line
                  Padding(
                  ...
                  Row(
                      children: <Widget>[
                      Icon(Icons.settings, color: menuTabColor,),
                      FlatButton(
                        onPressed: (){
                          return null;
                        },
                        child: Text("Settings", style: TextStyle(color: menuTabColor, fontSize: 20),)),
                      ]
                  ),
                  ...
                  Row(
                      children: <Widget>[
                      Icon(Icons.exit_to_app, color: menuTabColor,),
                      FlatButton(
                        onPressed: (){
                          return _auth.signOut();
                        },
                        child: Text("Log Out", style: TextStyle(color: menuTabColor, fontSize: 20),)),
                  ]
                ),
              ],
            ),
              ...
              children: <Widget>[
                Row(
                  ...
                  children: [
                    ...
                    InkWell(child: Icon(Icons.add_circle, color: Colors.black,),
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => CreateNewMeeting()),);
                    },
                    )
                  ]
                ),
